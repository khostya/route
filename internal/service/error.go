...
var (
	...
	ErrOrdersBelongToDifferentUsers          = errors.New("orders belong to different users")
	ErrMustBeAtLeastOneOrder                 = errors.New("must be at least one order")
	ErrOrderWeightGreaterThanWrapperCapacity = errors.New("order weight is greater than the wrapper capacity")
)
