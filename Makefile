...
vendor-proto/protoc-gen-openapiv2/options:
	git clone https://github.com/grpc-ecosystem/grpc-gateway vendor.proto/grpc-ecosystem &&\
...
vendor-proto/google/protobuf:
	...
	cd ./.. && \
	mkdir -p ./google &&\
	mv ./protobuf/src/google/protobuf ./google &&\
	rm -rf ./protobuf
...
vendor-proto/google/api:
	...
	cd ./.. && \
	mkdir -p ./google &&\
	mv ./googleapis/google/api ./google &&\
	rm -rf ./googleapis

.PHONY: vendor-proto/validate
vendor-proto/validate:
	git clone https://github.com/bufbuild/protoc-gen-validate vendor.proto/tmp &&\
	cd vendor.proto/tmp &&\
